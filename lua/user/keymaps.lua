...
-- Move line up & down like vscode in normal mode
keymap("n", "<A-S-j>", ":move .+1 <CR>", opts)
keymap("n", "<A-S-k>", ":move .-2 <CR>", opts)
...
-- Paste without yanking the highlighted word
keymap("v", "p", '"_dP', opts)
...
-- Telescope
-- keymap("n", "<C-p>", "<cmd>Telescope find_files find_command=rg, --ignore, --hidden, --files <cr>", opts)
